...
print("PUT /admin/posts/2")
update_post_data = {
    "title": "Updated Post Title",
    "content": "Updated post content by admin."
}
response = requests.put(f"{BASE_URL}/admin/posts/2", data=json.dumps(update_post_data), headers=HEADERS)
print_response(response)
...
print("POST /admin/posts/3/comments")
add_comment_data = {
    "content": "This is a test comment.",
    "created_at": datetime.utcnow().isoformat()
}
response = requests.post(f"{BASE_URL}/admin/posts/3/comments", data=json.dumps(add_comment_data), headers=HEADERS)
print_response(response)
...
print("PUT /admin/comments/3")
update_comment_data = {
    "content": "Updated comment content by admin."
}
response = requests.put(f"{BASE_URL}/admin/comments/3", data=json.dumps(update_comment_data), headers=HEADERS)
print_response(response)
